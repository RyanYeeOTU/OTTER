...
int main() {
	...
	static const float interleaved1[] = 
	{
			// X      Y    Z       R     G     B
			 ...
			 0.5f,  1.0f, 1.0f,   5.3f, 1.0f, 0.7f,
			0.f,  0.5f, 0.5f,   4.0f, 6.0f, 3.0f,
			0.f, -0.5f, 1.0f,   4.0f, 12.0f, 5.0f
		};
	...
	while (!glfwWindowShouldClose(window)) {
		...
		transform3 = glm::rotate(glm::mat4(1.f), static_cast<float>(thisFrame), glm::vec3(0, 1, 0));
